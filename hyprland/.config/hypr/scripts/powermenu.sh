...
all=(shutdown reboot suspend hybrid hibernate logout lockscreen)
...
#actions[switchuser]="???"
actions[logout]="/home/berk/.config/hypr/UserScripts/logout.sh"
actions[suspend]="systemctl suspend"
actions[hybrid]="systemctl hybrid-sleep"
